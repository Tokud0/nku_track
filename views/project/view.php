                        ...
                        <div class="nku-card__body">
                            ...
                            <?php if ($canManageDocuments): ?>
                                <form method="post" enctype="multipart/form-data"
                                    ...
                                    <div class="nku-dropzone" id="project-docs-dropzone">
                                        <input type="file"
                                               id="project-docs-input"
                                               name="documents[]"
                                        ...
                                        <div class="nku-dropzone__left">
                                            ...
                                            <div class="nku-dropzone__files" id="project-docs-files" style="display:none;"></div>
                                        </div>
                                        <div class="nku-dropzone__right">
                                            <label for="project-docs-input" class="nku-btn nku-btn--secondary">
                                                <i class="fas fa-folder-open me-2"></i>Выбрать файлы
                                            </label>
                                            <button type="submit" class="nku-btn nku-btn--primary nku-dropzone__submit" id="project-docs-submit">
...
<script>
document.addEventListener('DOMContentLoaded', function () {
    var dropzone = document.getElementById('project-docs-dropzone');
    var input = document.getElementById('project-docs-input');
    var filesBox = document.getElementById('project-docs-files');
    var submitBtn = document.getElementById('project-docs-submit');
